...
var SwaggerApi = function(url, Comments) {
  this.isBuilt = false;
  this.url = null;
  this.debug = false;
  this.basePath = null;
  ...
  if (Comments.success != null)
    this.success = Comments.success;

  if (typeof Comments.useJQuery === 'boolean')
    this.useJQuery = Comments.useJQuery;

  this.failure = Comments.failure != null ? Comments.failure : function() {};
  this.progress = Comments.progress != null ? Comments.progress : function() {};
  if (Comments.success != null) {
    this.build();
    this.isBuilt = true;
  }
...
SwaggerModelProperty.prototype.toString = function() {
  ...
  if (!this.required) {
    str += ', <span class="propOptKey">Commental</span>';
  }
  str += ')';
  if (this.values != null) {
...
var SwaggerRequest = function(type, url, params, opts, successCallback, errorCallback, operation, execution) {
  ...
  this.type = (type||errors.push("SwaggerRequest type is required (get/post/put/delete/patch/Comments)."));
 ...
 */
var JQueryHttpClient = function(Comments) {
  "use strict";
  if(!jQuery){
 ...
 */
var ShredHttpClient = function(Comments) {
